  ...
  return (
    <div className="logo-container">
      <div className="logo-group">
        ...
        <img src={logoLine} alt="logo-line" className="logo-line" />
      </div>
      ...
      <div className="shape">
        <svg
          ...
          fill="none"
        >
          <path d="M96.5 15.7563L161 73V215.5L81 286.5L1 215.5V73L81 2L96.5 15.7563ZM96.5 15.7563L31 73V215.5L111.5 286.5L191.5 215.5V73L113 2L96.5 15.7563Z" />
        </svg>
      </div>
    </div>
  );
